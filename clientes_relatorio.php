...
function Header()
  {
    ...
    $this->Cell(0, 15, utf8_decode("Clientes"), 0, 1, 'C');
...
$vRelatorio->Cell(120, 20, 'Nome', 0, 0, "C", 1);
$vRelatorio->Cell(100, 20, 'Logradouro', 0, 0, "C", 1);
$vRelatorio->Cell(70, 20, utf8_decode('Número'), 0, 0, "C", 1);
$vRelatorio->Cell(70, 20, 'Bairro', 0, 0, "C", 1);
$vRelatorio->Cell(70, 20, 'Cidade', 0, 0, "C", 1);
$vRelatorio->Cell(70, 20, 'Uf', 0, 0, "C", 1);
$vRelatorio->Cell(100, 20, 'Email', 0, 0, "C", 1);
$vRelatorio->Cell(140, 20, 'Telefone', 0, 1, "C", 1);
...
while($vTabela=mysqli_fetch_array($vExecucao)) 
     {
      ...
      $vNome=utf8_decode($vTabela['nome']);
      ...
      $vEmail=utf8_decode($vTabela['email']);
      $vCpf=utf8_decode($vTabela['cpf']);
      $vRg=utf8_decode($vTabela['rg']);
      $vData_nasc=utf8_decode($vTabela['data_nasc']);
      $vTelefone=utf8_decode($vTabela['telefone']);

      //Formata a cor do texto
      $vRelatorio->SetTextColor(0,0,0);
      //Publica os valores dos campos do registro atual
      $vRelatorio->Cell(120, 20, $vNome, 0, 0, "C");
      $vRelatorio->Cell(126, 20, $vLogradouro, 0, 0, "C");
      $vRelatorio->Cell(60, 20, $vNumero, 0, 0, "L");
      $vRelatorio->Cell(70, 20, $vBairro, 0, 0, "L");
      $vRelatorio->Cell(70, 20, $vCidade, 0, 0, "L");
      $vRelatorio->Cell(40, 20, $vUf, 0, 0, "C");
      $vRelatorio->Cell(160, 20, $vEmail, 0, 0, "L");
      $vRelatorio->Cell(70, 20, $vTelefone, 0, 1, "L");
     };
