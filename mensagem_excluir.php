...
<div class="container" style="padding-top:25px;">
  <div class="panel panel-danger">
    <div class="panel-heading"><center><b>Excluir Mensagens</b></center></div>
    <div class="panel-body">
      <center>
      <p>Confirma a exclusão de mensagem?</p>  
      <form method="post" action="mensagem_excluir_executar.php">
