...
function Header()
  {
    ...
    $this->Cell(0, 15, utf8_decode("Históricos"), 0, 1, 'C');
...
$vRelatorio->Cell(130, 20, utf8_decode('Descrição'), 0, 1, "L", 1);
