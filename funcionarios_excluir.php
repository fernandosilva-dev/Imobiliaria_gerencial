...
<div class="container" style="padding-top:25px;">
  <div class="panel panel-danger">
    <div class="panel-heading"><center><b>Excluir Funcionarios</b></center></div>
    <div class="panel-body">
      <center>
      <p>Confirma a exclusão de funcionario?</p>  
      <form method="post" action="funcionarios_excluir_executar.php">
