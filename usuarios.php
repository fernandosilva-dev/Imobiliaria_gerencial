...
function Filtrar()
  ...
  //Localiza o elemento input pelo seu ID e carrega na variável
  input = document.getElementById("vFiltro");
  //Transforma o resultado digitado pelo usuário em MAIUSCULO.
  filter = input.value.toUpperCase();
  //carrega a tabela criada lá em cima através do id
  table = document.getElementById("vTabela");
  //Pega as linhas da tabela e insere na variável
