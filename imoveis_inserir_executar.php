  ...
  <div class="panel panel-success">
    ...
    if ($_POST['vBotao'] == 'confirmar')
       ...
       $vSql='INSERT INTO imoveis
              (setor,quadra,lote,sublote,anexo, logradouro,numero, complemento,
               bairro, cidade,cep, uf,proprietario,descricao,foto,preco)
              VALUES
              ("'.$vSetor.'", "'.$vQuadra.'", "'.$vLote.'", "'.$vSublote.'","'.$vAnexo.'","'.$vLogradouro.'",
              "'.$vNumero.'", "'.$vComplemento.'","'.$vBairro.'", "'.$vCidade.'","'.$vCep.'", "'.$vUf.'", "'.$vProprietario.'", "'.$vDescricao.'", "'.$vFoto.'", "'.$vPreco.'")';
