...
<div class="container">
  <center><h2>CADASTRO DE CIDADES</h2></center>
...
echo '
    ...
    <div class="col-xs-6" style="text-align:right">
      <a target="_blank" class="btn btn-warning" href="cidades_relatorio.php">Imprimir Tabela</a>  
    </div>
  </div>
</div>
';
...
while($vTabela=mysqli_fetch_array($vExecucao)) 
     {
      ...
      if (isset($_COOKIE[$vCookieEditar])and
         ...
         {echo '<form method="post" action="cidades_editar.php">
      ...
      if (isset($_COOKIE[$vCookieExcluir])and
         ...
         {echo '<form method="post" action="cidades_excluir.php">
