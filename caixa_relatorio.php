...
function Header()
  {
    ...
    $this->Cell(0, 15, utf8_decode("Caixa"), 0, 1, 'C');
...
$vRelatorio->Cell(100, 20, 'Data', 0, 0, "L", 1);
$vRelatorio->Cell(100, 20, utf8_decode('Histórico'), 0, 0, "L", 1);
$vRelatorio->Cell(70, 20, 'Receita', 0, 0, "L", 1);
$vRelatorio->Cell(100, 20, 'Despesa', 0, 1, "L", 1);
...
while($vTabela=mysqli_fetch_array($vExecucao)) 
     {
      ...
      $vData=utf8_decode($vTabela['data']);
      $vHistorico=utf8_decode($vTabela['historico']);
      $vReceita=utf8_decode($vTabela['receita']);
      $vDespesa=utf8_decode($vTabela['despesa']);
      
      //Formata a cor do texto
      $vRelatorio->SetTextColor(0,0,0);
      //Publica os valores dos campos do registro atual
      $vRelatorio->Cell(100, 20,date_format(date_create($vData), 'd/m/Y'), 0, 0, "L");
      $vRelatorio->Cell(100, 20, $vHistorico, 0, 0, "L");
      $vRelatorio->Cell(70, 20,number_format($vReceita, 2, ',', '.'), 0, 0, "L");
      $vRelatorio->Cell(70, 20,number_format($vDespesa, 2, ',', '.'), 0, 1, "L");
     };
