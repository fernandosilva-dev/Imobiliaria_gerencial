...
function Header()
  {
    ...
    $this->Cell(0, 15, utf8_decode("mensagem"), 0, 1, 'C');
...
$vRelatorio->Cell(150, 20, 'Nome', 0, 0, "L", 1);
$vRelatorio->Cell(200, 20, 'Email', 0, 0, "L", 1);
$vRelatorio->Cell(150, 20, 'Telefone', 0, 0, "L", 1);
$vRelatorio->Cell(70, 20, 'Mensagem', 0, 1, "L", 1);
...
while($vTabela=mysqli_fetch_array($vExecucao)) 
     {
      ...
      $vMensagem=utf8_decode($vTabela['mensagem']);

      //Formata a cor do texto
      $vRelatorio->SetTextColor(0,0,0);
      //Publica os valores dos campos do registro atual
      $vRelatorio->Cell(150, 20, $vNome, 0, 0, "L");
      $vRelatorio->Cell(200, 20, $vEmail, 0, 0, "L");
      $vRelatorio->Cell(150, 20, $vTelefone, 0, 0, "L");
      $vRelatorio->Cell(200, 20, $vMensagem, 0, 1, "L");
     };
